        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold bg-gradient-to-r from-emerald-600 to-amber-500 bg-clip-text text-transparent leading-tight">
                Meet Agent Lexi
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="outline" size="lg" className="border-emerald-200 hover:bg-emerald-50 px-8 py-6 text-lg">
          ...
          <div className="relative">
            <Card className="bg-white/95 backdrop-blur-sm shadow-2xl border-0 overflow-hidden">
              ...
              <div className="bg-emerald-600 text-white p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-emerald-100 text-sm">🟢 Online • Responds in 3 seconds</p>
                </div>
              </div>
              ...
              <div className="p-4 space-y-4 h-96 overflow-y-auto">
                ...
                <div className="flex justify-end">
                  <div className="bg-emerald-100 text-emerald-900 rounded-lg px-4 py-2 max-w-xs">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="bg-gray-100 rounded-lg px-4 py-2 max-w-xs">
                    <p className="text-gray-900">Hello! Welcome to [Business Name]. Our 5GB data plan costs ₦2,500 and is valid for 30 days. Would you like me to help you purchase this plan?</p>
            ...
            <div className="absolute top-1/2 -left-8 w-4 h-4 bg-amber-300 rounded-full animate-ping"></div>
          </div>
        </div>
      </div>
    </section>
